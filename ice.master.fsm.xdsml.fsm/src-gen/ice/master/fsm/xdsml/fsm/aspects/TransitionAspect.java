...
public class TransitionAspect {
  public static boolean accepts(final Transition _self, final String event) {
	final ice.master.fsm.xdsml.fsm.aspects.TransitionAspectTransitionAspectProperties _self_ = ice.master.fsm.xdsml.fsm.aspects.TransitionAspectTransitionAspectContext
			.getSelf(_self);
	Object result = null;
