 ...
 * </p>
 * <ul>
 *   <li>{@link ice.master.fsm.xdsml.fsm.model.FiniteStateMachine#getInitial <em>Initial</em>}</li>
 *   <li>{@link ice.master.fsm.xdsml.fsm.model.FiniteStateMachine#getStates <em>States</em>}</li>
 *   <li>{@link ice.master.fsm.xdsml.fsm.model.FiniteStateMachine#getCurrent <em>Current</em>}</li>
 * </ul>
 *
 * @see ice.master.fsm.xdsml.fsm.model.ModelPackage#getFiniteStateMachine()
 * @model
 * @generated
 */
public interface FiniteStateMachine extends AbstractState {
	 ...
	 * @see ice.master.fsm.xdsml.fsm.model.ModelPackage#getFiniteStateMachine_Initial()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link ice.master.fsm.xdsml.fsm.model.FiniteStateMachine#getInitial <em>Initial</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link ice.master.fsm.xdsml.fsm.model.AbstractState}.
	 * It is bidirectional and its opposite is '{@link ice.master.fsm.xdsml.fsm.model.AbstractState#getParent <em>Parent</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ice.master.fsm.xdsml.fsm.model.ModelPackage#getFiniteStateMachine_States()
