 ...
 * </p>
 * <ul>
 *   <li>{@link ice.master.fsm.xdsml.fsm.model.impl.TransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link ice.master.fsm.xdsml.fsm.model.impl.TransitionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link ice.master.fsm.xdsml.fsm.model.impl.TransitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link ice.master.fsm.xdsml.fsm.model.impl.TransitionImpl#getTrigger <em>Trigger</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionImpl extends EObjectImpl implements Transition {
	...
	public AbstractState getSource() {
		if (eContainerFeatureID() != ModelPackage.TRANSITION__SOURCE) return null;
		return (AbstractState)eInternalContainer();
	}
	...
	public NotificationChain basicSetSource(AbstractState newSource, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSource, ModelPackage.TRANSITION__SOURCE, msgs);
		return msgs;
	}
	...
	public void setSource(AbstractState newSource) {
		if (newSource != eInternalContainer() || (eContainerFeatureID() != ModelPackage.TRANSITION__SOURCE && newSource != null)) {
			...
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, ModelPackage.ABSTRACT_STATE__OUTGOINGS, AbstractState.class, msgs);
			msgs = basicSetSource(newSource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TRANSITION__SOURCE, newSource, newSource));
	}
	...
	public void setTrigger(String newTrigger) {
		...
		trigger = newTrigger;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TRANSITION__TRIGGER, oldTrigger, trigger));
	}
	 ...
	 * @generated
	 */
	public AbstractState on(String event) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ModelPackage.TRANSITION__SOURCE:
				return eInternalContainer().eInverseRemove(this, ModelPackage.ABSTRACT_STATE__OUTGOINGS, AbstractState.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.TRANSITION__NAME:
				return getName();
			case ModelPackage.TRANSITION__TRIGGER:
				return getTrigger();
		}
