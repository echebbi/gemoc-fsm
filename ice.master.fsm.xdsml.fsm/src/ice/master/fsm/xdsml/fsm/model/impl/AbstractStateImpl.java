 ...
 * </p>
 * <ul>
 *   <li>{@link ice.master.fsm.xdsml.fsm.model.impl.AbstractStateImpl#getName <em>Name</em>}</li>
 *   <li>{@link ice.master.fsm.xdsml.fsm.model.impl.AbstractStateImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link ice.master.fsm.xdsml.fsm.model.impl.AbstractStateImpl#getOutgoings <em>Outgoings</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AbstractStateImpl extends EObjectImpl implements AbstractState {
	/**
	...
	public FiniteStateMachine getParent() {
		if (eContainerFeatureID() != ModelPackage.ABSTRACT_STATE__PARENT) return null;
	...
	public void setParent(FiniteStateMachine newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != ModelPackage.ABSTRACT_STATE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, ModelPackage.FINITE_STATE_MACHINE__STATES, FiniteStateMachine.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ABSTRACT_STATE__PARENT, newParent, newParent));
	}
	...
	public EList<Transition> getOutgoings() {
		if (outgoings == null) {
			outgoings = new EObjectContainmentWithInverseEList<Transition>(Transition.class, this, ModelPackage.ABSTRACT_STATE__OUTGOINGS, ModelPackage.TRANSITION__SOURCE);
		}
		return outgoings;
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ModelPackage.ABSTRACT_STATE__PARENT:
				return eInternalContainer().eInverseRemove(this, ModelPackage.FINITE_STATE_MACHINE__STATES, FiniteStateMachine.class, msgs);
		}
