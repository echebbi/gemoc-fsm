...
import ice.master.fsm.xdsml.fsm.model.ModelFactory;
...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @see ice.master.fsm.xdsml.fsm.model.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getAbstractState_Parent(), this.getFiniteStateMachine(), this.getFiniteStateMachine_States(), "parent", null, 0, 1, AbstractState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAbstractState_Outgoings(), this.getTransition(), this.getTransition_Source(), "outgoings", null, 0, -1, AbstractState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		EOperation op = addEOperation(abstractStateEClass, this.getAbstractState(), "on", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "event", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(abstractStateEClass, null, "onEnter", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(abstractStateEClass, null, "onExit", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getTransition_Source(), this.getAbstractState(), this.getAbstractState_Outgoings(), "source", null, 1, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = addEOperation(transitionEClass, ecorePackage.getEBoolean(), "accepts", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "event", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(transitionEClass, this.getAbstractState(), "on", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "event", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (abstractStateEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (abstractStateEClass.getEOperations().get(1), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (abstractStateEClass.getEOperations().get(2), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
