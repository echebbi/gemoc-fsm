 ...
 * </p>
 * <ul>
 *   <li>{@link ice.master.fsm.model.impl.FiniteStateMachineImpl#getInitial <em>Initial</em>}</li>
 *   <li>{@link ice.master.fsm.model.impl.FiniteStateMachineImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FiniteStateMachineImpl extends AbstractStateImpl implements FiniteStateMachine {
			...
			if (initial != oldInitial) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModelPackage.FINITE_STATE_MACHINE__INITIAL, oldInitial, initial));
			}
		}
		return initial;
	}
	...
	public void setInitial(AbstractState newInitial) {
		...
		initial = newInitial;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FINITE_STATE_MACHINE__INITIAL,
					oldInitial, initial));
	}
	...
	public EList<AbstractState> getStates() {
		if (states == null) {
			states = new EObjectContainmentWithInverseEList<AbstractState>(AbstractState.class, this,
					ModelPackage.FINITE_STATE_MACHINE__STATES, ModelPackage.ABSTRACT_STATE__PARENT);
		}
		return states;
	}
