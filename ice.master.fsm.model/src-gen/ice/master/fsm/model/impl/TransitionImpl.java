 ...
 * </p>
 * <ul>
 *   <li>{@link ice.master.fsm.model.impl.TransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link ice.master.fsm.model.impl.TransitionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link ice.master.fsm.model.impl.TransitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link ice.master.fsm.model.impl.TransitionImpl#getTrigger <em>Trigger</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	...
	public AbstractState getSource() {
		if (eContainerFeatureID() != ModelPackage.TRANSITION__SOURCE)
			return null;
	...
	public void setSource(AbstractState newSource) {
		if (newSource != eInternalContainer()
				|| (eContainerFeatureID() != ModelPackage.TRANSITION__SOURCE && newSource != null)) {
			...
			if (newSource != null)
				msgs = ((InternalEObject) newSource).eInverseAdd(this, ModelPackage.ABSTRACT_STATE__OUTGOINGS,
						AbstractState.class, msgs);
	...
	public void setTrigger(String newTrigger) {
		...
		trigger = newTrigger;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TRANSITION__TRIGGER, oldTrigger,
					trigger));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case ModelPackage.TRANSITION__SOURCE:
			return eInternalContainer().eInverseRemove(this, ModelPackage.ABSTRACT_STATE__OUTGOINGS,
					AbstractState.class, msgs);
		}
