...
public class FiniteStateMachineImpl extends MinimalEObjectImpl.Container implements FiniteStateMachine {
		...
		if (initial != null && initial.eIsProxy()) {
			...
			if (initial != oldInitial) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FsmPackage.FINITE_STATE_MACHINE__INITIAL,
							oldInitial, initial));
			}
		}
		return initial;
	...
	public void setInitial(State newInitial) {
		...
		initial = newInitial;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.FINITE_STATE_MACHINE__INITIAL, oldInitial,
					initial));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.FINITE_STATE_MACHINE__NAME, oldName,
					name));
	}
