/**
 */
package ice.master.fsm.xdsml.fsm.model.provider;
...
/**
 * This is the item provider adapter for a {@link ice.master.fsm.xdsml.fsm.model.FiniteStateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FiniteStateMachineItemProvider extends AbstractStateItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FiniteStateMachine_initial_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FiniteStateMachine_initial_feature", "_UI_FiniteStateMachine_type"),
				 ModelPackage.Literals.FINITE_STATE_MACHINE__INITIAL,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.FINITE_STATE_MACHINE__CURRENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.FINITE_STATE_MACHINE__STATES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.FINITE_STATE_MACHINE__STATES,
				 ModelFactory.eINSTANCE.createAbstractState()));
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.FINITE_STATE_MACHINE__STATES,
				 ModelFactory.eINSTANCE.createFiniteStateMachine()));
	}
