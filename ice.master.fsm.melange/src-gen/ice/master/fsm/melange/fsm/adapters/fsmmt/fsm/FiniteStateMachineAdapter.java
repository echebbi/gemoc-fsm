...
public class FiniteStateMachineAdapter extends EObjectAdapter<FiniteStateMachine> implements ice.master.fsm.melange.fsmmt.fsm.FiniteStateMachine {
  ...
  public State getCurrent() {
    return (State) adaptersFactory.createAdapter(ice.master.fsm.melange.fsm.aspects.FiniteStateMachineAspect.current(adaptee), eResource);
  }
  
  @Override
  public void setCurrent(final State current) {
    ice.master.fsm.melange.fsm.aspects.FiniteStateMachineAspect.current(adaptee, (ice.master.fsm.melange.fsm.fsm.State)((EObjectAdapter)current).getAdaptee()
    );
  }
  ...
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	...
    	case ice.master.fsm.melange.fsmmt.fsm.FsmPackage.FINITE_STATE_MACHINE__STATES:
    		return getStates();
    	case ice.master.fsm.melange.fsmmt.fsm.FsmPackage.FINITE_STATE_MACHINE__CURRENT:
    		return getCurrent();
    }
