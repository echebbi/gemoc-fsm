 ...
 *   <li>{@link ice.master.fsm.melange.fsmmt.fsm.FiniteStateMachine#getCurrent <em>Current</em>}</li>
 * </ul>
 *
...
public interface FiniteStateMachine extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link ice.master.fsm.melange.fsmmt.fsm.State#getMachine <em>Machine</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see ice.master.fsm.melange.fsmmt.fsm.FsmPackage#getFiniteStateMachine_Current()
	 * @model
	 * @generated
	 */
	State getCurrent();
	...
	/**
	 * Sets the value of the '{@link ice.master.fsm.melange.fsmmt.fsm.FiniteStateMachine#getCurrent <em>Current</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
