...
public class StateAspect {
  @Step
  public static AbstractState on(final State _self, final String event) {
    ...
    if (stepManager != null) {
    	stepManager.executeStep(_self,command,"State","on");
    } else {
    	command.execute();
    }
  ...
  protected static AbstractState _privk3_on(final StateAspectStateAspectProperties _self_, final State _self, final String event) {
